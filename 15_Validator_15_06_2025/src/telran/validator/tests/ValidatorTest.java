...
import static telran.validator.tests.telran.validator.tools.Validator.*;
...
class ValidatorTest {
    ...
    void testCheckCreditCard() {
        ...
        assertFalse(checkCreditCard("123456789_123456"));
    }
    ...
    void testCheckDateFormatEU() {
        ...
        assertFalse(checkDateFormatEU("10.21.2025"));
        assertFalse(checkDateFormatEU("32.12.2025"));
        assertFalse(checkDateFormatEU("2.12.2025"));
        assertFalse(checkDateFormatEU("30.2.2025"));
        assertFalse(checkDateFormatEU("12.12.22"));
        assertFalse(checkDateFormatEU("00.12.2002"));
        assertFalse(checkDateFormatEU("01.00.2002"));
        assertFalse(checkDateFormatEU("01/00/2002"));
        assertFalse(checkDateFormatEU("01.00.20029"));
    }
